...
export default function Accordion({ accordion }) {
  ...
  return (
    <li className="list-none relative bg-white border border-gray-200 rounded-lg mb-4 transition-all duration-300 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2">
      <button 
        type="button" 
