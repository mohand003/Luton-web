    ...
    <section id="faq" className="w-full py-16 bg-white">
      <Section>
        <div data-aos="fade-right" data-aos-delay="150" className="col-span-12 lg:col-span-6 px-4 sm:px-6 order-2 lg:order-1">
          <span className="text-base text-gradient font-semibold uppercase mb-4 sm:mb-2 block">Support</span>
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 sm:mb-6 text-neutral-800">Frequently asked questions</h2>
