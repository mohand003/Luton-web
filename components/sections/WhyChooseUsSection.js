      ...
      <Section>
        ...
        <div className="col-span-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
          <div data-aos="fade-up" className="bg-white p-6 rounded-lg">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-primary mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: '28px', letterSpacing: '-0.01em' }}>1. We use our own system</h3>
            <p className="text-base sm:text-lg" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, lineHeight: '22.75px' }}>
          ...
          <div data-aos="fade-up" data-aos-delay="150" className="bg-white p-6 rounded-lg">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-primary mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: '28px', letterSpacing: '-0.01em' }}>2. UK professionals, local Ghana understanding</h3>
            <p className="text-base sm:text-lg" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, lineHeight: '22.75px' }}>
          ...
          <div data-aos="fade-up" data-aos-delay="300" className="bg-white p-6 rounded-lg">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-primary mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: '28px', letterSpacing: '-0.01em' }}>3. Start with a low-cost pilot</h3>
            <p className="text-base sm:text-lg" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, lineHeight: '22.75px' }}>
          ...
          <div data-aos="fade-up" data-aos-delay="450" className="bg-white p-6 rounded-lg">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-primary mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: '28px', letterSpacing: '-0.01em' }}>4. We fix your process before we touch the software</h3>
            <p className="text-base sm:text-lg" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, lineHeight: '22.75px' }}>
          ...
          <div data-aos="fade-up" data-aos-delay="600" className="bg-white p-6 rounded-lg sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-xl sm:text-2xl font-semibold text-primary mb-3" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', fontWeight: 500, lineHeight: '28px', letterSpacing: '-0.01em' }}>5. Practical automation and AI</h3>
            <p className="text-base sm:text-lg" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, lineHeight: '22.75px' }}>
