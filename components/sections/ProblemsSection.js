        ...
        <div className="col-span-12 lg:col-span-6 px-4 lg:pl-8 mt-8 lg:mt-0 flex items-center">
          <div data-aos="fade-left" className="space-y-5 sm:space-y-6 w-full">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-neutral-800">
              The everyday <span style={{ 
                background: 'linear-gradient(136.91deg, #FC5012 -12.5%, #D43E0F 107.5%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent'
              }}>problems</span> Ghanaian businesses face
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4 mt-6 sm:mt-8">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-base sm:text-lg text-neutral-800">Too much manual paperwork</span>
              </div>
              <div className="flex items-start space-x-3">
                <IoCheckmarkCircleOutline className="text-primary flex-shrink-0 mt-0.5 sm:mt-1" size={20} />
                <span className="text-base sm:text-lg text-neutral-800">Stock going missing or hard to track</span>
              </div>
              <div className="flex items-start space-x-3">
                <IoCheckmarkCircleOutline className="text-primary flex-shrink-0 mt-0.5 sm:mt-1" size={20} />
                <span className="text-base sm:text-lg text-neutral-800">Approvals take too long</span>
              </div>
              <div className="flex items-start space-x-3">
                <IoCheckmarkCircleOutline className="text-primary flex-shrink-0 mt-0.5 sm:mt-1" size={20} />
                <span className="text-base sm:text-lg text-neutral-800">Reports arrive late or with wrong numbers</span>
              </div>
              <div className="flex items-start space-x-3">
                <IoCheckmarkCircleOutline className="text-primary flex-shrink-0 mt-0.5 sm:mt-1" size={20} />
                <span className="text-base sm:text-lg text-neutral-800">Systems don't match how people actually work</span>
              </div>
              <div className="flex items-start space-x-3">
                <IoCheckmarkCircleOutline className="text-primary flex-shrink-0 mt-0.5 sm:mt-1" size={20} />
                <span className="text-base sm:text-lg text-neutral-800">Dependence on 'one key person' for everything</span>
              </div>
            </div>
