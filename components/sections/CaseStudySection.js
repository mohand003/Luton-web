      ...
      <Section>
        <div className="col-span-12 lg:col-span-6 px-4 lg:pr-8 mt-8 lg:mt-0 flex items-center">
          <div data-aos="fade-right" className="space-y-8 w-full">
            {/* Main Heading */}
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.1] text-neutral-800" style={{ fontWeight: 700, letterSpacing: '-0.02em' }}>
              We tried it on ourselves first — <span style={{ color: '#FC5012' }}>and it works</span>
            </h2>
            
            {/* Sub-section 1 */}
            <div className="space-y-3">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-neutral-800" style={{ fontWeight: 700, letterSpacing: '-0.01em' }}>
                Built for our own operations
              </h3>
              <p className="text-base sm:text-lg md:text-xl text-neutral-600" style={{ fontWeight: 400, lineHeight: 1.6 }}>
