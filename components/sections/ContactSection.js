          ...
          <div className="col-span-12">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 px-4">
              ...
              <div data-aos="fade-right" className="space-y-8">
                <div>
                  <span className="text-base text-primary font-semibold uppercase tracking-wider">Contact</span>
                  <h2 className="text-4xl font-bold text-neutral-800 mt-2">Connect With Us</h2>
                </div>
                <p className="paragraph text-lg text-gray-600">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-neutral-800 mb-1">Find us</h4>
                      <p className="text-gray-600">6 Swan Street, Manchester, M4 5JN, UK</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-neutral-800 mb-1">Call us</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-neutral-800 mb-1">Mail us</h4>
                      <p className="text-gray-600">
