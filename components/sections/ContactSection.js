            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 px-4">
              ...
              <div data-aos="fade-right" className="space-y-8">
                <div>
                  ...
                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-neutral-800 mt-2" style={{ fontWeight: 700, letterSpacing: '-0.02em', lineHeight: '1.1' }}>Connect With <span style={{ color: '#FC5012' }}>Us</span></h2>
                </div>
